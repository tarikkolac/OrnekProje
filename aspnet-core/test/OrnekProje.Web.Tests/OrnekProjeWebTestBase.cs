...
{
    public abstract class OrnekProjeWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static OrnekProjeWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(OrnekProjeWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<OrnekProjeDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<OrnekProjeDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<OrnekProjeDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<OrnekProjeDbContext, Task<T>> func)
        {
            T result;
